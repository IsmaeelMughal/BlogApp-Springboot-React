...
function UserSuggestionsOnOthersPosts() {
        ...
        async function fetchData() {
            try {
                const res = await myAxios.get(
                    `${BASE_URL}/post/suggestion/otherSuggestionOnUserPost`,
                    {
                        headers: {
                            Authorization: `Bearer ${JSON.parse(
                                localStorage.getItem("token")
                ...
                if (res.status === 200) {
                    ...
                    if (res.data.data.length === 0) {
                        toast("No Suggestions on Your Posts!!!");
                    } else {
                        toast(res.data.message);
                    }
                } else {
                ...
                toast("Failed To Fetch Suggestions On Your Posts!!!");
            }
        }
        fetchData();
    }, []);
...
export default UserSuggestionsOnOthersPosts;
