...
public class PostLikeService {
    ...
    public ResponseDTO<String> postLikeByIds(String authHeader, Integer postId)
    {
        ...
        {
            return new ResponseDTO<>(null, HttpStatus.BAD_REQUEST, "You have already liked this Post!!!");
        }
        PostLikeEntity postLikeEntity = new PostLikeEntity();
        postLikeEntity.setUserByUserId(optionalUser.get());
        postLikeEntity.setPostByPostId(optionalPost.get());
        postLikeRepository.save(postLikeEntity);
        return new ResponseDTO<>("Post Liked Successfully!!!", HttpStatus.OK, "Post Liked Successfully!!!");
    }
}
